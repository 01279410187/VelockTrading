...
const TradingProgress = () => {
  ...
  const Navigate = () => {
    window.location.href = "/tradingProgress/Cancel";
  };
      ...
      <div className="  my-6  w-full md:w-[35%] sm:w-[35%]">
        ...
        <div className="w-full border-2 border-black ">
          ...
          <div className="justify-center border-t-4 border-[#959595]">
            <h1 className="mt-3 text-[#959595]     text-[15px]">
              TRADINGS IN PROGRESS
            </h1>
          </div>
          <div className="flex justify-center">
            <table className="w-full gap-5 mt-4">
              <tr className="">
                <th className="text-[#959595] font-normal flex-col"><p>Start</p> <p>Date</p></th>
                <th className="text-[#959595] font-normal flex-col"><p>Finish</p> <p>Time</p></th>
                <th className="text-[#959595] font-normal flex-col"><p>Trading</p> <p>Amount</p></th>
                <th className="text-[#959595] font-normal flex-col"><p>Daily</p> <p>Profit</p></th>
                <th className="text-[#959595] font-normal flex-col"><p>Trading</p> <p>Status</p></th>
                <th className="text-[#959595] font-normal flex-col"><p>Cancel</p> <p>Trading</p></th>
              </tr>
              {TradingData.map((val, key) => {
                return (
                  <tr key={key} className=" ">
                    ...
                    <td className="text-[12px] text-green-600 font-poppins text-center ">
                      {val.TradingStatus}
                    </td>
                    <td className="text-[12px]    font-poppins text-center    ">
                    <button className="text-white bg-red-500 rounded-md p-0.5" onClick={()=>Navigate()}>{val.CancelTrading}</button>
                    </td>
                  </tr>
                );
              })}

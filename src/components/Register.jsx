          ...
          <form className="mt-3" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-1 w-[80%]">
              ...
              <input
                ...
                {...register("referrals")}
              />
              <div className="text-[#ea3636]">{errors.referrals?.message}</div>
              <p className={`block text-sm mt-1  text-gray-800`}>
                I have read, understood, and agreed with the disclaimer and
                privacy & policy
              </p>
            </div>
